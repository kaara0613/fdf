...
/*   Updated: 2025/01/06 19:22:48 by kaara            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_map(t_coordinate *map_size,
			t_coordinate_data ***map, char **xpm_data)
{
	...
	while (map_size->y_i < map_size->y)
	{
		while (map_size->x_i < map_size->x)
		{
			if (map_size->x_i + 1 < map_size->x)
				draw_line_bresenham_x(map_size, map, xpm_data);
			if (map_size->y_i + 1 < map_size->y)
				draw_line_bresenham_y(map_size, map, xpm_data);
			map_size->x_i++;
		}
		map_size->y_i++;
		map_size->x_i = 0;
